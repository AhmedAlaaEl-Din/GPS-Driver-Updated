...
/* Defining CAN TX Interface Registers */
#define CANIF1CRQ(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x020))
#define CANIF1CMSK(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x024))
#define CANIF1MSK1(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x028))
#define CANIF1MSK2(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x02C))
#define CANIF1ARB1(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x030))
#define CANIF1ARB2(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x034))
#define CANIF1MCTL(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x038))
#define CANIF1DA1(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x03C))
#define CANIF1DA2(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x040))
#define CANIF1DB1(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x044))
#define CANIF1DB2(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x048))

/* Defining CAN RX Interface Registers */
#define CANIF2CRQ(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x080))
#define CANIF2CMSK(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x084))
#define CANIF2MSK1(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x088))
#define CANIF2MSK2(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x08C))
#define CANIF2ARB1(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x090))
#define CANIF2ARB2(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x094))
#define CANIF2MCTL(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x098))
#define CANIF2DA1(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x09C))
#define CANIF2DA2(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x0A0))
#define CANIF2DB1(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x0A4))
#define CANIF2DB2(CAN_ID)               *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x0A8))

/* Defining CAN TX Message Object Registers */
#define CANTXRQ1(CAN_ID)                *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x100))
#define CANNWDA1(CAN_ID)                *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x120))
#define CANMSG1INT(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x140))
#define CANMSG1VAL(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x160))

/* Defining CAN RX Message Object Registers */
#define CANTXRQ2(CAN_ID)                *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x104))
#define CANNWDA2(CAN_ID)                *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x124))
#define CANMSG2INT(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x144))
#define CANMSG2VAL(CAN_ID)              *((CAN_RegAddType)(CANBaseAddressLut[CAN_ID] + 0x164))
...
CAN_CheckType CAN_Init(void)
{
    ...
    for(LoopIndex = 0; (LoopIndex < CAN_GROUPS_NUMBER) && (ErrorFlag == 0); LoopIndex ++)
    {
        if(CAN_ConfigParam[LoopIndex].CANId < CAN_NUMBER)
        {
            ...
            /* If CANId equals to 0 it initializes CAN0 and if it equals to 1 it initializes CAN1 */
            ...
            //CANTST(CAN_ConfigParam[LoopIndex].CANId) |= Mode_Selector;
            ...
            if(CAN_ConfigParam[LoopIndex].InterruptEnable == 1)
            {
                ...
                //CANIF2MCTL(CAN_ConfigParam[LoopIndex].CANId) |= 0x400;
            }
            /* */
...
CAN_CheckType CAN_TxData(uint8_t ChannelID, uint8_t *DataPtr, uint8_t Module)
{
    ...
    if(CAN_ConfigParam[ChannelID].CANId < CAN_NUMBER)
    {
        ...
        //CANIF1MCTL(CAN_ConfigParam[ChannelID].CANId) |= 0x2000;
